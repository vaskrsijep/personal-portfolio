    ...
    return (
      ...
      <div className="card-container flex lg:flex-row flex-col gap-4 lg:w-1/2 w-full lg:h-[55vh] h-[90vh] px-5">
        <div className="card rounded-xl lg:w-1/2 w-full h-full bg-accent relative">
          ...
          <div className="absolute bottom-[16%] lg:left-[10%] left-[5%] rounded-2xl px-4 py-1 lg:text-[1vw] tracking-tight text-black font-medium  uppercase outline outline-1 outline-black">
            Software Engineer
          </div>
        </div>
